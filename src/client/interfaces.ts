import { CommandInteraction, Events, SlashCommandBuilder, Message, Collection, ButtonInteraction, Client, ModalSubmitInteraction, SelectMenuInteraction } from "discord.js";
import StellarClient from "./StellarClient";
import fs from "fs";
import path from "path";

// Command stuff
type StellarCommandData = Omit<SlashCommandBuilder, "addSubcommand" | "addSubcommandGroup">;
